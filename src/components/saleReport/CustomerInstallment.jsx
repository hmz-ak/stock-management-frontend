...
const CustomerInstallment = (props) => {
                ...
                <TableRow key={row._id}>
                  ...
                  <TableCell align="left">
                    <Button
                      onClick={(e) => {
                        console.log(row._id);
                        props.history.push("/getInvoiceCustomer/" + row._id);
                      }}
                      style={{ backgroundColor: "#548CA8", color: "white" }}
                    >
                      View
                    </Button>
                  </TableCell>
...
export default withRouter(CustomerInstallment);
